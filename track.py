                ...
                if len(outputs) > 0:
                    for j, (output, conf) in enumerate(zip(outputs, confs)):
                        ...
                        if save_txt:
                            ...
                            # bboxes -> bounding boxun konumları    # [x, y, width, height]
                            # id -> cismin id'si
                            # cls = c -> cismin sınıfı(etiketi)  0 top - 1 insan
                            # label -> cls Person/Ball conf
                            
                            
                            with open(f"ballCoord.txt", "a") as f:
                                myStr = f'{(bboxes, id, cls, c, label)}\n'

                                # print(bboxes, id, cls, c, label)
                                # print(type(cls))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='2_10sec.mp4', help='source')  # file/folder, 0 for webcam
